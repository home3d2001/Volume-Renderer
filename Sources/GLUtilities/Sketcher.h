...
namespace GLUtilities {
	...
	private: 
		void add_2d_internal(vector<QuadNode> &o, int i, float2 offset, float scale, float3 color);
		void add_3d_internal(vector<QuadNode> &o, int i, float3 offset, float scale, float3 color);
		void setupPoints() {
