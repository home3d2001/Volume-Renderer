...
//	/* Upload dependencies */
//	cl::Buffer b_zpoints;
//	CLFW::getBuffer(b_zpoints, "zpoints", CLFW::NextPow2(numPts) * sizeof(big));
...
//		(CLFW::NextPow2(numPts) - numPts) * sizeof(big));
//
//	/* Benchmark */
//	BEGIN_ITERATIONS("Check Order") {
//		BEGIN_BENCHMARK
//			cl_int result;
//		CheckBigOrder_p(b_zpoints, CLFW::NextPow2(numPts), result);
//		END_BENCHMARK
//	} END_ITERATIONS;
//}
//
...
//	/* Load dependencies */
//	cl_int numPts = readFromFile<cl_int>("BenchmarkData//binaries//numPts.bin");
//	vector<float2> points = readFromFile<float2>("BenchmarkData//binaries//points.bin", numPts);
//	BoundingBox2D bb = readFromFile<BoundingBox2D>("BenchmarkData//binaries//bb.bin");
//	Resln resln = readFromFile<Resln>("BenchmarkData//binaries//resln.bin");
//
//	/* Upload dependencies */
//	cl::Buffer b_points, b_qpoints;
//	CLFW::getBuffer(b_points, "points", numPts * sizeof(float2));
//	CLFW::Upload<float2>(points, b_points);
//
//	/* Benchmark */
//	BEGIN_ITERATIONS("Quantize Points") {
//		BEGIN_BENCHMARK
//			Quantize2DPoints_p(b_points, numPts, bb, resln.width, to_string(i), b_qpoints);
//		END_BENCHMARK
//	} END_ITERATIONS;
//}
...
//		BEGIN_BENCHMARK
//			QPoints2DToZPoints_p(b_qpoints, numPts, resln.bits, to_string(i), b_zpoints);
//		END_BENCHMARK
//	} END_ITERATIONS;
//}
//
...
//		BEGIN_BENCHMARK
//			cl_int numOctnodes;
//		BinaryRadixToQuadtree_p(b_brt, false, nullBuffer, numPts, to_string(i), b_octree, numOctnodes);
//		END_BENCHMARK
//	} END_ITERATIONS;
//}
...
//		BEGIN_BENCHMARK
//			cl_int numOctnodes;
//		BinaryRadixToQuadtree_p(b_brt, true, b_brtCols, numPts, to_string(i), b_octree, numOctnodes);
//		END_BENCHMARK
//	} END_ITERATIONS;
//}
...
//	vector<QuadNode> octree = readFromFile<QuadNode>("BenchmarkData//binaries//octree.bin", numOctnodes);
//
//	/* Upload dependencies */
//	cl::Buffer b_octree, b_leaves;
//	CLFW::getBuffer(b_octree, "octree", numOctnodes * sizeof(QuadNode));
//	CLFW::Upload<QuadNode>(octree, b_octree);
//
//	/* Benchmark */
//	BEGIN_ITERATIONS("Generate Leaves") {
//		BEGIN_BENCHMARK
//			cl_int numLeaves;
//		GetQuadLeaves_p(b_octree, numOctnodes, b_leaves, numLeaves);
//		END_BENCHMARK
//	} END_ITERATIONS;
//}
...
//	vector<QuadNode> octree = readFromFile<QuadNode>("BenchmarkData//binaries//pruned_octree.bin", numOctnodes);
//
//	/* Upload dependencies */
//	cl::Buffer b_octree, b_leaves;
//	CLFW::getBuffer(b_octree, "octree", numOctnodes * sizeof(QuadNode));
...
//	CLFW::getBuffer(b_zpoints, "zpoints", numPts * sizeof(QuadNode));
...
//		BEGIN_BENCHMARK
//			LookUpQuadnodeFromLCP_p(b_lineLCPs, numLines, b_octree, b_LCPToOctNode);
//		END_BENCHMARK
//	} END_ITERATIONS;
//}
...
//				b_LCPBounds, b_lines, numLines, b_qpoints, resln.width, false, b_sparseConflicts);
//		END_BENCHMARK
//	} END_ITERATIONS;
//}
//
